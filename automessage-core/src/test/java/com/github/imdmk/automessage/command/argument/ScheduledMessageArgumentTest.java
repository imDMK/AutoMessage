...
class ScheduledMessageArgumentTest {
    ...
    private final Invocation<Object> invocation = mock(Invocation.class);

    @SuppressWarnings("unchecked")
    private final Argument<ScheduledMessage> argument = mock(Argument.class);

    private final ScheduledMessageArgument<Object> resolver =
            new ScheduledMessageArgument<>(new FakeRepository());

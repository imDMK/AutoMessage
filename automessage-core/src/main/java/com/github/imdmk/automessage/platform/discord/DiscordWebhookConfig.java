...
@Header({
        ...
        "#",
        "# Placeholders describing the server - {ONLINE}, {MAX_PLAYERS}, {DATE}, {TIME} -",
        "# are filled in normally. The ones describing a reader - {PLAYER}, {WORLD} and",
        "# the like - have no value in a channel with many readers and are removed, as",
        "# are any PlaceholderAPI tokens that turn out to need a player.",
        "#",
        "# Source Code:",
